                    ...
                    <tbody>
                        @foreach($categories as $category)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.blogs.index', ['category_id' => $category->id]) }}" class="btn btn-sm btn-success text-white"><i class="fas fa-list"></i> Manage Blogs</a>
                                    <a href="{{ route('admin.blog-categories.edit', $category) }}" class="btn btn-sm btn-info text-white">Edit</a>
