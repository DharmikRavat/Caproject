...
<body class="admin-body">
    ...
    <div class="admin-shell">
        <aside class="admin-sidebar" data-admin-sidebar>
            <a href="{{ route('admin.dashboard') }}" class="admin-brand"><img src="https://via.placeholder.com/40/ffffff/000000?text=CA" class="admin-brand-logo" alt="CA Logo"><span><strong>JITESH TELHARA</strong><small>& ASSOCIATES LLP</small></span></a>
